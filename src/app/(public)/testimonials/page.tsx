...
const caseStudies = [
	{
		...
		content: (
			<>
				<p className="mb-4">
					The Westfield High School debate team went from regional
					competitors to national champions in just one season after
					implementing DebateMate into their training regimen.
				</p>
				<p className="mb-4">
					&quot;The personalized feedback and structured learning
					paths helped our students identify and overcome their
					weaknesses quickly. The real-time analysis during practice
					sessions was a game-changer.&quot; - Coach David Thompson
				</p>
	...
	},
	{
		...
		content: (
			<>
				{" "}
				<p className="mb-4">
					The Cambridge Debate Society integrated DebateMate into
					their training program to prepare for the World Universities
					Debating Championship.
				</p>
				<p className="mb-4">
					&quot;DebateMate&apos;s AI analysis helped us refine our
					argumentation and delivery in ways that traditional coaching
					couldn&apos;t. The ability to get instant feedback on
					practice rounds was invaluable.&quot; - Team Captain
				</p>
				<p className="font-medium">Results:</p>
				<ul className="list-disc list-inside space-y-1 text-sm">
			...
			<div className="container pt-24 pb-8 mx-auto">
				<div className="max-w-3xl mx-auto text-center mb-16">
					...
					<p className="text-xl text-muted-foreground">
						Hear from students, educators, and institutions who have
						transformed their debate skills with DebateMate.
					</p>
				</div>
			</div>
