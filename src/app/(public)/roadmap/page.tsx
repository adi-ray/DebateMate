		...
		<main className="min-h-screen">
			<div className="container mx-auto px-4 pt-24 pb-8">
				...
				>
					...
					>
						<SelectTrigger className="w-full rounded-xl p-4 border-indigo-200 dark:border-indigo-200/50 focus:ring-indigo-500 cursor-pointer">
...
function TimelineNode({ milestone, index, accentColor }: TimelineNodeProps) {
	...
	const colorClass =
		accentColor === "indigo"
			? "bg-indigo-600 text-indigo-600 border-indigo-200 dark:border-indigo-200/50"
			: "bg-teal-500 text-teal-500 border-teal-200 dark:border-teal-200/50";
	...
	return (
		...
		>
			<div
				className={cn(
					"absolute left-2 p-3 rounded-full text-gray-100",
					colorClass.split(" ")[0]
				)}
			>
				{milestone.icon}
