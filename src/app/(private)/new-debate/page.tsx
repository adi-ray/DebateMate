...
const predefinedTopics = [
  { id: 1, title: "Artificial Intelligence should be regulated by governments", category: "Technology" },
  { id: 2, title: "Social media has more negative than positive effects on society", category: "Social Issues" },
  { id: 3, title: "Climate change requires immediate drastic action over gradual change", category: "Environment" },
  { id: 4, title: "Universal Basic Income should be implemented globally", category: "Economics" },
  { id: 5, title: "Space exploration funding should be prioritized over poverty reduction", category: "Policy" },
  { id: 6, title: "Genetic engineering of humans should be allowed", category: "Ethics" },
  { id: 7, title: "Remote work is better than office work for productivity", category: "Work Culture" },
  { id: 8, title: "Cryptocurrency will replace traditional currency", category: "Finance" }
];
...
export default function NewDebatePage() {
  ...
  // New enhanced state
  const [debateState, setDebateState] = useState<DebateState>("topic-selection");
  ...
  const startDebate = () => {
    ...
    // Initial AI message
    const aiOpeningPrompt = `You are an AI debate opponent. The debate topic is: "${finalTopic}". The human is arguing ${userPosition === 'for' ? 'FOR' : 'AGAINST'} this position, so you must argue ${userPosition === 'for' ? 'AGAINST' : 'FOR'} it. 
...
Respond only with your opening argument, nothing else.`;
    ...
    const initialMessage: Message = {
      id: "initial",
      content: `Great! Let's debate "${finalTopic}". I'll argue ${userPosition === 'for' ? 'AGAINST' : 'FOR'} this position while you argue ${userPosition === 'for' ? 'FOR' : 'AGAINST'} it. This is Round 1 - you have 3 minutes. Let me start with my opening statement: 
...
${generateAIResponse(aiOpeningPrompt, true)}`,
  ...
  const handleRoundEnd = () => {
    ...
    if (currentRound < maxRounds) {
      ...
      const transitionMessage: Message = {
        ...
        content: `Round ${currentRound} has ended! Moving to Round ${currentRound + 1}. The timer has been reset.`,
        sender: "ai",
        timestamp: new Date(),
  ...
  const endDebate = () => {
    ...
    const endMessage: Message = {
      id: "debate-end",
      content: "The debate has concluded! Thank you for the engaging discussion. Check your final scores and feedback.",
      sender: "ai",
      timestamp: new Date(),
    };
  ...
  const generateAIResponse = (userMessage: string, isOpening = false): string => {
    if (isOpening) {
      ...
      >
        <div className="p-6">
          ...
          <div className="border-t pt-4 mb-6">
            <label className="block text-sm font-medium mb-2">Custom Topic:</label>
            <Input
              value={customTopic}
              onChange={(e) => {
          ...
          <div className="flex gap-3">
            <Button onClick={() => setShowTopicModal(false)} variant="outline">
              Cancel
            </Button>
            {(selectedTopic || customTopic) && userPosition && (
              <Button onClick={() => { startDebate(); setShowTopicModal(false); }}>
                Start Debate
              </Button>
            )}
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="text-center p-4 rounded-lg bg-muted">
                ...
                <div className="text-2xl font-bold text-primary">{scores.user.total}</div>
              ...
              <div className="text-center p-4 rounded-lg bg-muted">
                ...
                <div className="text-2xl font-bold text-destructive">{scores.ai.total}</div>
                <div className="text-xs space-y-1 mt-2">
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={() => setDebateState("debate-active")} variant="outline">
                Review
              </Button>
            </div>
          </div>
      ...
      <div className="h-full flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">
            Choose a topic and position to start your AI-powered debate experience
          </p>
    ...
    <div className="h-full flex flex-col">
      ...
      <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border bg-accent px-4 sm:px-6 rounded-md">
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          {/* Topic Badge */}
          {topic && (
            <Badge variant="secondary" className="hidden sm:inline-flex max-w-48 truncate">
              {topic}
            </Badge>
          )}
          ...
          {debateState === "debate-active" && (
            <div className="hidden md:flex items-center gap-2 text-sm">
              <span className="text-primary font-semibold">{scores.user.total}</span>
              <span className="text-muted-foreground">vs</span>
              <span className="text-destructive font-semibold">{scores.ai.total}</span>
            </div>
          )}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => setIsTimerActive(!isTimerActive)}>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-xs font-medium">
                          {message.sender === "user" ? "You" : "Professor Logic"}
                        </span>
                        {message.round && (
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="font-bold text-primary">{scores.user.total}</span>
                      </div>
                    ...
                    <div className="border-t pt-3">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="font-bold text-destructive">{scores.ai.total}</span>
                      </div>
                      <div className="text-xs space-y-1 text-muted-foreground">
                        <div className="flex justify-between">
                          <span>Logic</span>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="flex items-end gap-2">
            ...
            <Button
              variant="outline"
              size="icon"
              className={isSpeaking ? "bg-blue-100 text-blue-500 dark:bg-blue-900/20" : ""}
            ...
            <Button 
              ...
              disabled={!inputValue.trim() || debateState !== "debate-active" || isTyping}
            >
